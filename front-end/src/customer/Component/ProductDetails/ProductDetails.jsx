...
import {Rating, Button,Grid, LinearProgress} from '@mui/material';
  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        {/* Product info */}
        <div className="lg: col-span-1 mx-auto max-w-2xl  lg: max-w-7xl px-4 pb-16 pt-10 sm:px-6 lg:px-8 lg:pb-24 lg:pt-16">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <div className="mt-6">
              <div className="flex space-x-3 items-center">
                ...
                <p className="opacity-50 text-sm">560 Ratings</p>
                <p className="opacity-50 text-sm font-medium text-indigo-600 hover:text-indigo-500">43 Reviews</p>
              </div>
        ...
        <section>
              ...
              <div className="border p-5">
                <Grid container spacing={7}>
                  ...
                  <Grid item xs={5}>
                    ...
                    <Box className='mt-5 space-y-3 p-2'> 
         ...
         <section className="pt-10">
           ...
           <div className='flex flex-wrap  space-y-5'>
             {mensKurthas.map((item)=><HomeSectionCard product={item} />)}
           </div>
         </section>
